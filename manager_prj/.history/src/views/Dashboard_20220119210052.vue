...
import baseURL from "../service/baseUrl.js"
    export default {
        ...
        async mounted() {
            ...
            // const index = res.data.forEach(el => {
            //     console.log(el.email);
            // });
            // let email = [...dataLogin][0].email;
           const index =  res.data.findIndex(el => el.email === [...dataLogin][0].email)
           console.log(index);
            console.log("đây là của login",[...dataLogin][0].email);
        },
        methods: {
            onButtonClick(item) {
